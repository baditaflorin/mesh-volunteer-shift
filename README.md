...
Live: **https://baditaflorin.github.io/mesh-volunteer-shift/**

Source: **https://github.com/baditaflorin/mesh-volunteer-shift**
...
git clone https://github.com/baditaflorin/mesh-volunteer-shift
cd mesh-volunteer-shift
npm install
npm run dev
```
...
- `mesh-volunteer-shift:signalingUrl`
- `mesh-volunteer-shift:turnTokenUrl`
- `mesh-volunteer-shift:iceServers`
- `mesh-volunteer-shift:room`
